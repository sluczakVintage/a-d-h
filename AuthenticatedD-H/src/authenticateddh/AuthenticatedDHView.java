 ...
 */
public class AuthenticatedDHView extends FrameView {

    public AuthenticatedDHView(SingleFrameApplication app) {
        super(app);
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = AuthenticatedDHApp.getApplication().getMainFrame();
            aboutBox = new AuthenticatedDHAboutBox(mainFrame);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(authenticateddh.AuthenticatedDHApp.class).getContext().getResourceMap(AuthenticatedDHView.class);
